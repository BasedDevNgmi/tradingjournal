    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      {showList && (
        <PopoverContent
          id="news-event-list"
          role="listbox"
          className="w-[var(--radix-popover-trigger-width)] p-0 overflow-hidden max-h-[min(360px,70vh)] flex flex-col"
          align="start"
          sideOffset={4}
        ...
        >
          <div
            ref={listRef}
            className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden overscroll-contain py-1 scrollbar-thin max-h-[min(320px,60vh)]"
